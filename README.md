...
Qué hace
Clona el repo en ~/opt/<nombre>/
Si detecta Python (requirements.txt, setup.py o pyproject.toml), crea un venv e instala las dependencias
Crea un launcher en ~/.local/bin/ con el nombre del repo
Ya puedes llamar a la herramienta desde cualquier sitio
Desinstalar
bash
